...
namespace ArcaneDuel.Game
{
    ...
    public static partial class CuratedDeckLists
    {
        ...
        public static readonly uint[] YugiMutoBattleCityMain =
        {
            ...
            87910978, 98645731, 24094653, 83764719,
            70368879, 5556668, 81510157, 24096228,
        ...
        public static readonly uint[] ShiranuiSupremacyMain =
        {
            33420078, 74003290, 74003290, 74003290,
            41562624, 79783880, 79783880,
            5177985, 5177985, 40364916, 74798297,
            78936551, 78936551, 78936551, 5325155,
            72700231, 83266006, 41867019, 41867019,
            39753577, 39753577, 39753577, 23116808,
            27198001, 27198001, 27198001, 68722455,
            52467217, 56198785, 56198785, 12612470,
            68989981, 68989981, 65422840, 66788016,
            30888983, 60082869,
            32120116, 32120116, 32120116
        };

        public static readonly uint[] ShiranuiSupremacyExtra =
        {
            59843383, 52711246, 52711246,
            26326541, 86926989, 26326541,
            3486020, 4103668, 77092311,
            30607616, 52615248
        };

        public static readonly uint[] MausoleumLockdownEdisonMain =
        {
            97077563, 44095762, 72302403, 87910978,
            18144507, 1475311, 98380593, 98380593,
            73628505, 70368879, 98645731,
            37694547, 37694547, 37694547,
            80921533, 80921533, 80921533,
            19665973, 19665973, 19665973,
            24317029, 24317029, 98777036, 44330098,
            89111398, 77585513, 77585513,
            12298909, 12298909,
            47084486, 47084486, 47084486,
            5556499, 83104731, 83104731,
            50933533, 50933533, 50933533,
            47297616, 47297616
        };

        public static readonly uint[] MausoleumLockdownEdisonExtra =
        {
            79229522, 79229522, 79229522,
            23693634, 44508094, 70780151,
            88643579, 70902743, 73580471,
            7391448, 50321796, 19974580,
            73580471, 53714009, 26593852
        };
